...
def parse_args():
    ...
    parser.add_argument("--analysis-root", type=Path, default=Path("experiment_data/vehicle4_v2/analysis/method_comparison_v1"))
...
def main():
    ...
    manifest = {"methods": METHODS, "model": "yolov5s", "confidence_threshold": 0.4,
                "iou_threshold": 0.5, "conditions_per_method": 15,
                "primary_bucket": ">=0.90", "method_summary": str(summary_path),
